...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF6] flex items-center justify-center p-4 overflow-hidden relative">
      ...
      >
        <div className="bg-white border border-gray-100 p-10 rounded-[3rem] shadow-xl">
          <div className="flex flex-col items-center mb-10">
            <div className="bg-yellow-400 p-4 rounded-2xl mb-6 shadow-lg shadow-yellow-400/20">
              <FileText className="w-10 h-10 text-black" />
            </div>
            <h1 className="text-3xl font-black text-[#0F172A] tracking-tight mb-2">SMART TRACK</h1>
            <p className="text-gray-500 text-sm font-medium">Admin Portal Login</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  placeholder="admin"
                  className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 pl-12 pr-4 text-[#0F172A] placeholder:text-gray-400 focus:ring-2 focus:ring-yellow-400 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  placeholder="••••••••"
                  className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 pl-12 pr-12 text-[#0F172A] placeholder:text-gray-400 focus:ring-2 focus:ring-yellow-400 outline-none transition-all"
                />
                <button 
                  type="button"
