      ...
      <div className="flex-1 max-w-md mx-4 lg:mx-8">
        <div className="relative group">
          ...
          <input 
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-100 border-none rounded-xl text-sm focus:ring-2 focus:ring-yellow-400 transition-all placeholder:text-gray-400"
          />
        </div>
      </div>
